...
def extract_info_from_filename(filename):
    ...
    if match:
        ...
        version = match.group(2) + "_" + match.group(3)
        os_name = match.group(5).replace('_', ' ').capitalize().split("_")[0] + " " + match.group(6)
        arch = match.group(7).split("_")[0] if "_" in match.group(7) else match.group(7)
...
# Write separate JSON file for  MongooseIM
